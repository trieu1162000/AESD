    ...
    public partial class cardManagerForm : Form
    {
        ...
        private async void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (listViewCard.Items.Count == 20)
                {
                    MessageBox.Show("Cannot add more than 20 rows.");
                    return;
                }
                ...
                } while (mainForm.entireMainFormRecievedFrame.Length < 10);
        ...
        private async void btnSyncCard_Click(object sender, EventArgs e)
        {
            ...
            } while (((mainForm.entireMainFormRecievedFrame.Length < (length + 7)) && (length > 0))   // Length of frame must greater than the length of frames of all cards
                    || (length == 0)
        ...
        public uint SyncParseLengthRawStream(byte[] rawStream)
        {
            ...
            Console.Write("Length raw: " + rawStream.Length.ToString());
